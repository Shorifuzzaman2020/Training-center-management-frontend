...
// import { FaCopyright, FaTwitter } from 'react-icons/fa';
...
//                         <footer className="footer sm:footer-horizontal bg-indigo-900 text-base-content p-10">
//                             <aside>
//                                 <Image
...
//                                     </div>
//                                     <div>
//                                         <p className='text-gray-300'>795 Folsom Ave, Suite 600, San Francisco, CA 94107</p>
//                                     </div>
//                                 </div>
//                                 <div className='flex justify-center items-center gap-3'>
//                                     <div>
...
//                                     </div>
//                                     <div>
//                                         <p className='text-gray-300'>+990 79594107</p>
//                                     </div>
//                                 </div>
//                                 <div className='flex justify-center items-center gap-3'>
//                                     <div>
...
//                                     </div>
//                                     <div>
//                                         <p className='text-gray-300'>webdeveloper@gmail.com</p>
//                                     </div>
//                                 </div>
//                             </aside>
//                             <nav>
//                                 <h6 className=" text-gray-50 font-bold">QUICK LINKS</h6>
//                                 <div>
...
//                             </nav>
//                             {/* <nav>
//                                 <h6 className=" text-gray-50 font-bold">PHOTOGRAMS</h6>
...
//                             </nav> */}
//                             <nav>
//                                 <h6 className="text-gray-50 font-bold">Courses</h6>
...
//                         </div>
//                         <div>
//                             <p className='text-white'>All Rights Reserved IOD</p>
//                         </div>
//                     </div>
...
//                         </div>
//                         <div className='hover: text-white'>
//                             <p className='text-gray-400 hover:text-white'>TERMS AND CONDITION</p>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
const page = () => {
  return (
    <div className="bg-indigo-900">
      <footer className="tracking-wide w-11/12 mx-auto px-8 sm:px-12 pt-12 pb-6">
        <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-0">
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between lg:gap-12 mt-8 lg:mt-0">
            <div className="">
            ...
            <div className="]">
              <h4 className="text-white font-semibold text-base relative mt-12 lg:mt-0">
                Platforms
              </h4>
            ...
            <div className="">
              <h4 className="text-white font-semibold text-base relative mb-7 mt-12 lg:mt-0">
                Contact Us
              </h4>
        ...
        <div className="flex flex-wrap max-md:flex-col gap-4">
          <ul className="md:flex md:space-x-6 max-md:space-y-2">
            <li>
              <Link
                href="javascript:void(0)"
                className="hover:text-slate-900 text-gray-400 text-sm font-normal"
              >
                Terms of Service
              </Link>
            </li>
