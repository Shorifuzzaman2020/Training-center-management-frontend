...
//     const navLinks = [
//         { name: "Manage Notice", href: "/notice"},
//         { name: "Create Blog", href: "/create-blog"},
//         { name: "Manage Attendance", href: "/employee-attendance"},
//     ];
...
const StudentDashboardLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const navLinks = [
    {
      name: "Course Details",
      href: "/student-dashboard/course-details",
      icon: <Bell className="w-4 h-4" />,
    },
    {
      name: "Payment History",
      href: "/student-dashboard/payment-history",
      icon: <FileText className="w-4 h-4" />,
    },
    {
      name: "Result",
      href: "/student-dashboard/result",
      icon: <FileText className="w-4 h-4" />,
    },
    {
      name: "Certificates",
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      >
        ...
        <div className="p-5 border-b border-indigo-700 flex justify-between items-center">
          {isSidebarOpen && <h2 className="text-xl font-bold">Student Dashboard</h2>}
      ...
      <main className="flex-1">
        ...
        <div className="bg-white shadow px-6 py-4 flex justify-between">
          <h1 className="font-semibold">
            {navLinks.find((l) => l.href === pathname)?.name || "Student Dashboard"}
          </h1>
