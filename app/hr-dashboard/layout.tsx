...
const HrDashboardLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const navLinks = [
    {
      name: "Manage Notice",
      href: "/hr-dashboard/notice",
      icon: <Bell className="w-4 h-4" />,
    },
    {
      name: "Create Blog",
      href: "/hr-dashboard/create-blog",
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      >
        ...
        <div className="p-5 border-b border-indigo-700 flex justify-between items-center">
          {isSidebarOpen && <h2 className="text-xl font-bold">HR Dashboard</h2>}
      ...
      <main className="flex-1">
        ...
        <div className="bg-white shadow px-6 py-4 flex justify-between">
          <h1 className="font-semibold">
            {navLinks.find((l) => l.href === pathname)?.name || "HR Dashboard"}
          </h1>
